...
public class GiaoDienDanhSachHoaDon extends JFrame implements ActionListener {
	...
	public GiaoDienDanhSachHoaDon(String tenKH, String tenNV, Date tuNgay, Date denNgay, int trangThai,String maNV) {
		this.maNV = maNV;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (o.equals(btnXemChiTiet)) {
			...
			if (row != -1) {
				...
				GiaoDienChiTietPhieuThue ct = new GiaoDienChiTietPhieuThue(maHD,maNV, trThai);
				ct.setVisible(true);
				setVisible(false);
			}
