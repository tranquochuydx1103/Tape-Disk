...
public class GiaoDienDanhSachPhieuThue extends JFrame implements ActionListener {
	...
	public GiaoDienDanhSachPhieuThue(String maNV) {
		this.maNV = maNV;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (o.equals(btnTraBangDia)) {
			...
			if (row != -1) {
				...
				GiaoDienChiTietPhieuThue hd = new GiaoDienChiTietPhieuThue(maHD,maNV, 0);
				hd.setVisible(true);
				setVisible(false);
			}
